//
//  NSAttributedString+LiuAddition.m
//  支付宝(练习2)
//
...
#import "NSAttributedString+LiuAddition.h"

@implementation NSAttributedString (LiuAddition)
+ (instancetype)liu_imageTextWithImage:(UIImage *)image imageWH:(CGFloat)imageWH title:(NSString *)title fontSize:(CGFloat)fontSize titleColor:(UIColor *)titleColor spacing:(CGFloat)spacing {
